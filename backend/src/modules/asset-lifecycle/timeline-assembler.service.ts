...
const VISUALS: Record<AssetLifecycleEventType, TimelineVisual> = {
  ...
  BUDGET_APPROVED: {
    ...
    subtitle: 'Proposta comercial aprovada para o ativo',
    category: 'budget',
  },
  BUDGET_REJECTED: {
    icon: 'file-x-2',
    ...
    subtitle: 'Proposta comercial rejeitada',
    category: 'budget',
  },
  PMOC_CREATED: {
  ...
  DOCUMENT_RENDERED: {
    ...
    subtitle: 'Documento oficial renderizado pelo Document Engine',
    category: 'document',
  },
  FINANCIAL_ENTRY_CREATED: {
    ...
    subtitle: 'Registro financeiro vinculado ao ativo',
    category: 'financial',
  },
  FINANCIAL_ENTRY_PAID: {
    icon: 'badge-dollar-sign',
    color: '#16A34A',
    title: 'Lançamento financeiro pago',
    subtitle: 'Movimento financeiro liquidado',
    category: 'financial',
  },
  FINANCIAL_ENTRY_CANCELED: {
    icon: 'ban',
    color: '#DC2626',
    title: 'Lançamento financeiro cancelado',
